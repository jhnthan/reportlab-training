...
page_design_two = PageTemplate(
    id='page_design_two',
    frames=[frame_design_two],
    # onPage=_doNothing,
    # onPageEnd=_doNothing,
    pagesize=(200,200), # this override pagesize of the BaseDocTemplate
    autoNextPageTemplate=None,
    cropBox=None,
    artBox=None,
    trimBox=None,
...
content.append(
  Paragraph(
    "This is a Paragraph on the page 2 ",
    ParagraphStyle(
      'MyStyle1',
      fontSize=10,
    )
